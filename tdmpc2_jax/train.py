...
from tdmpc2_jax.envs.raisim import make_raisim_env
from tdmpc2_jax.networks import NormedLinear
from tdmpc2_jax.networks.conv import ImageEncoder, MultiModalEncoder
...
def train(cfg: dict):
    ...
    def make_env(env_config, seed):
        ...
        if env_config.backend == "gymnasium":
            ...
            return env
        elif env_config.backend == "raisim":
            _env = make_raisim_env(
                env_config.env_id, seed, env_config, env_config.raisim.obs_type
            )
            env = gym.wrappers.RecordEpisodeStatistics(_env)
            return env
    ...
    encoder_module = MultiModalEncoder(
        image_encoder=image_encoder,
        mlp_encoder=mlp_encoder,
        fuse_dim=encoder_config.fuse_dim,
    ...
    encoder_param_key, encoder_augment_key = jax.random.split(encoder_key, 2)
        ...
        if mngr.latest_step() is not None:
            ...
            restored = mngr.restore(
                ...
                args=ocp.args.Composite(
                    ...
                    # TODO: Revive this when https://github.com/google/orbax/pull/956 is merged
            ...
            if global_step >= seed_steps:
                ...
                for iupdate in range(num_updates):
                    ...
                    agent, train_info = agent.update(
                        ...
                        pixel_observations=batch["observation"]["pixels"],
                        actions=batch["action"],
                        rewards=batch["reward"],
                        next_observations=batch["next_observation"]["state"],
                        next_pixel_observations=batch["next_observation"]["pixels"],
